...
IOmniDrive* Factory::createDriveSubsystem()
{
    ...
    L298N* leftFrontMotor = new L298N(*pwmLeftFront, *leftFrontSetForward, *leftFrontSetBack);
    L298N* leftRearMotor = new L298N(*pwmLeftRear, *leftRearSetForward, *leftRearSetBack);
    L298N* rightFrontMotor = new L298N(*pwmRightFront, *rightFrontSetForward, *rightFrontSetBack);
    L298N* rightRearMotor = new L298N(*pwmRightRear, *rightRearSetForward, *rightRearSetBack);
